...
<body>
    <div class="container page-wrap">
        ...
        <div class="topbar d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span class="badge-soft">Create new supplier</span>
                </div>
                <div class="text-muted small">Add vendor details to manage stock-in, invoices, and contacts.</div>
            </div>
        ...
        <div class="card card-soft">
            ...
            <div class="card-body p-4">
                <form id="createForm" method="POST" action="{{ route('admin.suppliers.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-hint mt-1">Example: Sokha Supplier</div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="icon-wrap">
                                <span class="input-icon">📝</span>
                                <textarea name="note" class="form-control" rows="4" placeholder="Extra details...">{{ old('note') }}</textarea>
                            </div>
                        </div>
                    </div>
    ...
    `;
        ...
        // show first validation error as toast too
        @if ($errors->any())
