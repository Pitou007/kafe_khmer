...
<head>
  ...
  <style>
    ...
    .field input, .field select{ padding-left: 56px; }
...
<div class="container page-wrap">
  ...
  <div class="topbar d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    <div>
      <div class="d-flex align-items-center gap-2">
        ...
        <span class="badge-soft">Create new employee profile</span>
      </div>
      <div class="text-muted small">Fill in required fields then click Save.</div>
    </div>
  ...
  <div class="row g-3">
    <div class="col-lg-8">
      <div class="card card-soft">
        <div class="card-head d-flex justify-content-between align-items-center">
          ...
          <div class="text-muted small">Required: Name, Position</div>
        </div>

        <div class="card-body p-4">
          <form id="empForm" method="POST" action="{{ route('admin.employees.store') }}">
            @csrf
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <div class="hint">Example: Sok Dara</div>
              </div>
                ...
                <div class="field">
                  ...
                  <select name="position_id" class="form-select" required>
                    ...
                    @foreach ($positions as $pos)
                      <option value="{{ $pos->id }}" @selected(old('position_id') == $pos->id)>
                        {{ $pos->name }}
                      </option>
                    @endforeach
                  </select>
                </div>
                <div class="hint">Choose employee role</div>
              </div>
            ...
            <div class="d-flex gap-2 mt-4">
              <button id="saveBtn" class="btn btn-success flex-grow-1" type="submit">
                ✅ Save Employee
              </button>
    ...
    <div class="col-lg-4">
      <div class="card card-soft">
        <div class="card-head">
          <div class="fw-bold">Quick Notes</div>
        </div>
        <div class="card-body">
          <div class="text-muted small mb-2">✅ Name and Position are required</div>
          <div class="text-muted small mb-2">✅ Phone/Email can be empty</div>
          <div class="text-muted small">✅ Start date is useful for reports</div>
        </div>
      </div>
    </div>
